...
public interface LinkNetworkStatsMapper extends BaseMapper<LinkNetworkStatsDO> {
    ...
    @Insert("INSERT INTO t_link_network_stats (full_short_url, gid, date, cnt, network, create_time, update_time, del_flag) " +
            "VALUES( #{linkNetworkStatsDO.fullShortUrl}, #{linkNetworkStatsDO.gid}, #{linkNetworkStatsDO.date}, #{linkNetworkStatsDO.cnt}, #{linkNetworkStatsDO.network}, NOW(), NOW(), 0) " +
            "ON DUPLICATE KEY UPDATE cnt = cnt +  #{linkNetworkStatsDO.cnt};")

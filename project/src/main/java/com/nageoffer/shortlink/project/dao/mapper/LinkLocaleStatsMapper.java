...
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {
    ...
    @Insert("INSERT INTO t_link_locale_stats (full_short_url, gid, date, cnt, country, province, city, adcode, create_time, update_time, del_flag)" +
            "VALUES(#{linkLocaleStatsDO.fullShortUrl},#{linkLocaleStatsDO.gid},#{linkLocaleStatsDO.date},#{linkLocaleStatsDO.cnt},#{linkLocaleStatsDO.country},#{linkLocaleStatsDO.province},#{linkLocaleStatsDO.city},#{linkLocaleStatsDO.adcode},NOW(),NOW(),0) ON DUPLICATE KEY UPDATE cnt = cnt + #{linkLocaleStatsDO.cnt};")
